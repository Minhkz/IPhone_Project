        ...
        <div class="address__main">
            ...
            <div class="address__main--content d-flex justify-content-between align-items-center"
                ...
                <div class="address__main--right me-4">
                    <fmt:formatNumber value="0" type="number" pattern="#,##0"/> VNĐ
                </div>
            </div>
            ...
            <div class="address__main--content d-flex justify-content-between align-items-center"
                ...
                <div class="address__main--right me-4">
                    <fmt:formatNumber value="29000" type="number" pattern="#,##0"/> VNĐ
                </div>
            </div>
            ...
            <div class="address__main--content d-flex justify-content-between align-items-center"
                ...
                <div class="address__main--right me-4">
                    <fmt:formatNumber value="49000" type="number" pattern="#,##0"/> VNĐ
                </div>
            </div>
